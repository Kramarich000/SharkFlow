...
export const priorityStyles = {
  LOW: 'border-[2px] bg-green-100 hover:bg-green-500 !transition-all border-green-500 shadow-[0_6px_20px_rgba(41,221,107,0.35)] hover:shadow-[0_10px_30px_rgba(41,221,107,0.5)]',
  MEDIUM:
...
export const statusCardStyles = {
  IN_PROGRESS:
    'border-[2px] bg-[var(--main-button-hover)]  !transition-all border-blue-500 shadow-[0_6px_20px_rgba(68, 41, 221, 0.35)] hover:shadow-[0_10px_30px_rgba(68, 41, 221, 0.5)]',
  PENDING:
    'border-[2px] bg-[var(--main-button-hover)]  !transition-all border-yellow-400 shadow-[0_6px_20px_rgba(255,201,39,0.35)] hover:shadow-[0_10px_30px_rgba(255,201,39,0.5)]',
  COMPLETED:
    'border-[2px] bg-[var(--main-button-hover)] !transition-all border-green-500 shadow-[0_6px_20px_rgba(47, 255, 75, 0.35)] hover:shadow-[0_10px_30px_rgba(47, 255, 75, 0.5)]',
  CANCELLED:
    'border-[2px] bg-[var(--main-button-hover)]  !transition-all border-red-500 shadow-[0_6px_20px_rgba(255,47,47,0.35)] hover:shadow-[0_10px_30px_rgba(255,47,47,0.5)]',
  DEFAULT:
    'border-[2px] bg-[var(--main-button-hover)]  !transition-all border-gray-300 shadow-[0_4px_12px_rgba(0,0,0,0.1)] hover:shadow-[0_6px_18px_rgba(0,0,0,0.15)]',
};
